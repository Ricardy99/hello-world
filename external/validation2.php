...
/*In the below script, we validate all fields and then mail the message 
using PHP mail() function. Also, the sender will get the copy of his mail.*/
$name =""; // Sender Name
...
$msg1 = " $name Contacted Us. Hereis some ination about $name.
Name: $name
E-mail: $email
Purpose: $purpose
